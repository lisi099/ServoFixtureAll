...
public:
    lcd_protocol(QSerialPort *port):serial_(port)
    {
        ...
        int i =0;
        version_map_index_.insert(42, i);
        ++i;
        version_map_index_.insert(43, i);
        ++i;
        version_map_index_.insert(44, i);
        ++i;
        version_map_index_.insert(20, i);
        ++i;
        version_map_index_.insert(21, i);
        is_tai_servo_ = false;
    }
