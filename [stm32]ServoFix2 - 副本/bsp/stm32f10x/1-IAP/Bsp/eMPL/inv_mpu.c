...
u8 i2c_write(u8 dev, u8 reg, u8 length, u8 *data)
{
	SPI1_6000_WriteReg_NByte(reg, data, length);
	return 0;
}

u8 i2c_read(u8 dev, u8 reg, u8 length, u8 *data)
{
	SPI1_6000_ReadReg_NByte(reg, data, length);
	return 0;
}
...
//#define i2c_write(a,b,c,d)   SPI1_6000_WriteReg_NByte(b,d,c)
//#define i2c_read(a,b,c,d)    SPI1_6000_ReadReg_NByte(b,d,c)
