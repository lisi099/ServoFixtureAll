...
#define KEY_RE_PIN                    	(GPIO_Pin_4)
#define KEY_UP_PIN                    	(GPIO_Pin_5)
#define KEY_DOWN_PIN                  	(GPIO_Pin_6)
#define KEY_OK_PIN                    	(GPIO_Pin_7)

#define read_re_button()				(!GPIO_ReadInputDataBit(GPIOA, KEY_RE_PIN))
#define read_up_button()				(!GPIO_ReadInputDataBit(GPIOA, KEY_UP_PIN))
#define read_down_button()				(!GPIO_ReadInputDataBit(GPIOA, KEY_DOWN_PIN))
#define read_ok_button()				(!GPIO_ReadInputDataBit(GPIOA, KEY_OK_PIN))
