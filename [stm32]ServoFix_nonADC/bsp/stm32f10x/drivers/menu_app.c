...
struct Item Setting_item[] =
{
    ...
    (char*)"2.Turn Boost",							0,  0,  14,  1, SHOW_NUM, 1, 10,
    (char*)"3.Dead Band",						0,  0,  14,  1, SHOW_NUM, 1, 10,
    (char*)"4.Response Lv",							0,  0,  14,  1, SHOW_NUM, 1, 3,
    (char*)"5.Max Torque",							0,  0,  14,  1, SHOW_NUM, 1, 10,
    (char*)"6.Turn Brake",							0,  0,  14,  1, SHOW_NUM, 1, 10,
    (char*)"7.Center Adjust",				&Servo_Center_Page,  0,  14,  1, SHOW_NULL, 1, 10,
    (char*)"8.Soft Start",						0,  0,  14,  1, SHOW_STRING, 0, 1,
    (char*)"9.UpLoad Data",			&Data_Save_Page,  0,  0,  3, SHOW_NULL, 0, 0,
