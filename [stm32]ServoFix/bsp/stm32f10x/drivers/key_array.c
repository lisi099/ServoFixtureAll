...
#define read_up_button()				(!GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_4))
#define read_down_button()				(!GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_5))
#define read_ok_button()				(!GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_6))
